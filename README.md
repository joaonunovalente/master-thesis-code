...
This project uses ESP32 microcontrollers and ADXL337 and MPU-6050 accelerometers and is programmed in **C/C++**.

The document can be found [here](master-thesis.pdf).
